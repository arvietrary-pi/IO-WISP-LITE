...
**Status:** Multi-project control and reliable project-folder creation

IO Wisp Lite is a single-file, no-AI construction plan indexer and estimator's fieldbook.

## Start it

1. Download `IO_Wisp_Lite_V0.0.4.html`.
...
9. Use **Scope Brief** to paste a request or load a `.txt`, `.md`, or `.json` brief. Apply it to separate inclusions, exclusions, and clarifications.
